...
/// Error Message: "number of leaves in the MMR of the MMR Frontier exceeded 4294967295 (2^32 - 1)"
pub const ERR_MMR_FRONTIER_LEAVES_NUM_EXCEED_LIMIT: MasmError = MasmError::from_static_str("number of leaves in the MMR of the MMR Frontier exceeded 4294967295 (2^32 - 1)");
