...
pub const ERR_B2AGG_WRONG_NUMBER_OF_ASSETS: MasmError = Cow::Borrowed("B2AGG script requires exactly 1 note asset");
/// Error Message: "B2AGG script expects exactly 6 note inputs"
pub const ERR_B2AGG_WRONG_NUMBER_OF_INPUTS: MasmError = Cow::Borrowed("B2AGG script expects exactly 6 note inputs");

/// Error Message: "maximum scaling factor is 18"
pub const ERR_SCALE_AMOUNT_EXCEEDED_LIMIT: MasmError = Cow::Borrowed("maximum scaling factor is 18");
