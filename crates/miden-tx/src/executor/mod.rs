...
impl TransactionExecutor {
    ...
    pub fn execute_transaction(
        ...
        let advice_recorder: RecAdviceProvider = advice_inputs.into_advice_inputs().into();
    ...
    pub(crate) fn try_execute_notes(
        ...
        let advice_provider: MemAdviceProvider = advice_inputs.into_advice_inputs().into();
