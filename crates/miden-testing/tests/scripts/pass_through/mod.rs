...
/// The components of the account a pass-through transaction runs on: `AuthPassThrough`,
/// `BasicWallet` so input notes can deposit into it, and `PassThroughSweep` for the account
/// procedure the scripts call.
