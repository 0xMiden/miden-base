...
// TODO: Should we remove this test? Essentially, the prover already validates that advice inputs
// are sufficient for reexecution.
/// Tests that the transaction witness retrieved from an executed
/// transaction contains all necessary advice input to execute the transaction again.
// #[tokio::test]
