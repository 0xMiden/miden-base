...
// Re-export NetworkId and AddressType from miden-protocol for convenience
pub use miden_protocol::address::{AddressType, CustomNetworkId, NetworkId};
...
mod tests {
    ...
    use miden_protocol::AccountIdError;
