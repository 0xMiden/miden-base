...
/// Error Message: "MINT script expects storage of length 9"
pub const ERR_MINT_UNEXPECTED_STORAGE_LENGTH: MasmError = MasmError::from_static_str("MINT script expects storage of length 9");
...
/// Error Message: "P2IDE note expects storage of length 4"
pub const ERR_P2IDE_UNEXPECTED_STORAGE_LENGTH: MasmError = MasmError::from_static_str("P2IDE note expects storage of length 4");
...
/// Error Message: "P2ID note expects storage of length 2"
pub const ERR_P2ID_UNEXPECTED_STORAGE_LENGTH: MasmError = MasmError::from_static_str("P2ID note expects storage of length 2");

/// Error Message: "SWAP script expects storage of length 12"
pub const ERR_SWAP_UNEXPECTED_STORAGE_LENGTH: MasmError = MasmError::from_static_str("SWAP script expects storage of length 12");
