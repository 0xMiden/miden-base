...
/// Error Message: "MINT script expects exactly 8 or 16 note inputs"
pub const ERR_MINT_WRONG_NUMBER_OF_INPUTS: MasmError = MasmError::from_static_str("MINT script expects exactly 8 or 16 note inputs");
