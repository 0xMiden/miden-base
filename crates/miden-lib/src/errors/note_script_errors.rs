...
/// Error Message: "computed assets commitment does not match the one obtained from assets info"
pub const ERR_OUTPUT_ASSETS_COMMITMENT_MISMATCH: MasmError = MasmError::from_static_str("computed assets commitment does not match the one obtained from assets info");
