...
/// code cannot be changed during the user code execution, only in the epilogue, so the initial code
/// commitment will be equal to the native account code commitment whenever it is called by a user.
