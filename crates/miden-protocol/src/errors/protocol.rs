...
/// Error Message: "the specified number of note storage does not match the actual number"
pub const ERR_NOTE_INVALID_NUMBER_OF_STORAGE_ITEMS: MasmError = MasmError::from_static_str("the specified number of note storage does not match the actual number");
