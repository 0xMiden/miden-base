...
mod test {
    ...
    fn test_invalid_token_len() {
        ...
        let encoded_felt: Felt = encoded_symbol.into();
        let invalid_encoded_symbol_u64 = encoded_felt.as_canonical_u64() - 3;
    ...
    fn test_token_symbol_max_value() {
        ...
        let token_felt: Felt = token_symbol.into();
        assert_eq!(token_felt.as_canonical_u64(), TokenSymbol::MAX_ENCODED_VALUE);
    }
    ...
    fn test_from_static_str_matches_new() {
        ...
        for symbol in symbols {
            ...
            let from_new_felt: Felt = from_new.into();
            let from_static_felt: Felt = from_static.into();
            assert_eq!(from_new_felt, from_static_felt, "Mismatch for symbol: {}", symbol);
        }
    }
