...
The [storage](https://docs.rs/miden-objects/latest/miden_protocol/account/struct.AccountStorage.html) consists of up to 256 individual [storage slots](https://docs.rs/miden-objects/latest/miden_protocol/account/enum.StorageSlot.html), where each slot consists of:
- Key: Slot name.
