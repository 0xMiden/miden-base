...
| `get_storage`            | Writes the note's [inputs](note.md#inputs) to the specified memory address.<br/><br/>**Inputs:** `[dest_ptr]`<br/>**Outputs:** `[storage_len, dest_ptr]`                           | Note    |
...
| `get_storage_info`   | Returns the [inputs](note.md#inputs) commitment and length of the input note with the specified index.<br/><br/>**Inputs:** `[note_index]`<br/>**Outputs:** `[NOTE_STORAGE_COMMITMENT, storage_len]`                                | Any     |
...
| Procedure                   | Description                                                                                                                                                                                                             | Context |
| --------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- |
| `compute_storage_commitment` | Computes the commitment to the output note storage starting at the specified memory address.<br/><br/>**Inputs:** `[storage_ptr, storage_len]`<br/>**Outputs:** `[STORAGE_COMMITMENT]`                                      | Any     |
...
| `build_recipient`           | Builds the recipient hash from note storage, script root, and serial number.<br/><br/>**Inputs:** `[storage_ptr, storage_len, SERIAL_NUM, SCRIPT_ROOT]`<br/>**Outputs:** `[RECIPIENT]`                                     | Any     |
