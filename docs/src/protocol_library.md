...
| `get_initial_balance` | Returns the balance of a fungible asset associated with a faucet_id in the native account's vault at the beginning of the transaction.<br><br>Inputs: `[faucet_id_prefix, faucet_id_suffix]`<br>Outputs: `[init_balance]` | Any |
