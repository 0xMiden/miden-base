...
- [BREAKING] Update `account::get_storage_commitment` procedure to `account::compute_current_storage_commitment`([#1763](https://github.com/0xMiden/miden-base/pull/1763)).
