...
- [BREAKING] Renamed the config note dispatch selector to the note variant, which renames the `VARIANT_*` and `ERR_*_UNKNOWN_VARIANT` constants and changes the config note script roots ([#3834](https://github.com/0xMiden/protocol/issues/3834)).
