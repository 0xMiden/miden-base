...
- Added `AuthNone` component to the set of standard components ([#1620]([(https://github.com/0xMiden/miden-base/pull/1527](https://github.com/0xMiden/miden-base/pull/1620)))). 
