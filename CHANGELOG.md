...
- [BREAKING] Separate account APIs (`miden::account` and `kernel::account`) into `active_account` and `native_account` ([#2026](https://github.com/0xMiden/miden-base/pull/2026)).
