...
- Moved `MAX_ASSETS_PER_NOTE` into `protocol_utils::constants` and re-exported it from `miden::protocol::constants`, making it importable outside the transaction kernel ([#3821](https://github.com/0xMiden/protocol/pull/3821)).
