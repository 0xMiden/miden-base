...
- [BREAKING] Update `TransactionExecutor` and `NoteConsumptionChecker` to return `NoteConsumptionError` containing `Note` rather than `NoteId` ([#1680](https://github.com/0xMiden/miden-base/pull/1680)).
