...
- [BREAKING] Reorganized note-related modules, created `current_note` module, added `build_recipient` procedure ([#1807](https://github.com/0xMiden/miden-base/pull/1807)).
