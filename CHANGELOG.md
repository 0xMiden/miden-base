...
- [BREAKING] Rename `BlockHeader` to `UnsignedBlockHeader` and add public key and function to sign the header ([#2128](https://github.com/0xMiden/miden-base/pull/2128)).
