...
- [BREAKING] Add public key `BlockHeader` and signing functionlity through `EcdsaSigner` trait and `LocalEcdsaSigner` impl  ([#2128](https://github.com/0xMiden/miden-base/pull/2128)).
