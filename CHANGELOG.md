...
- Added the `pass_through::single_p2id` transaction script, `PassThroughSweep` account component, and `AuthPassThrough` auth component for fee-less, stateless pass-through accounts ([#3713](https://github.com/0xMiden/protocol/pull/3713)).
