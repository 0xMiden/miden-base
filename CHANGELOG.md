...
- Added `AddressInterface` type to represent the interface of the account to which an `Address` points ([#1761](https://github.com/0xMiden/miden-base/pull/#1761), [#1801](https://github.com/0xMiden/miden-base/pull/#1801)).
