...
- Added B2AGG note consumption check that validates the note attachment targets the consuming account ([#2334](https://github.com/0xMiden/miden-base/pull/2334)).
