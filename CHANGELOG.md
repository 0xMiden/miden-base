...
- Added Rust `TransactionEvent` and `TransactionEvents` types with checked appends, bounded serialization, and ordered event commitments ([#3833](https://github.com/0xMiden/protocol/pull/3833)).
