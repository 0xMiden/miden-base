...
- Added `miden::standards::access::ownable2step` standard module for component ownership management (including new tests). ([#2292](https://github.com/0xMiden/miden-base/pull/2292)).
