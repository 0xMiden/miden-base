...
- [BREAKING] TX_FEE notes leave their assets in the note for the consuming account's own code to collect, and `StandardNote::is_consumable` reports a well-formed TX_FEE note as undetermined ([#3843](https://github.com/0xMiden/protocol/pull/3843)).
