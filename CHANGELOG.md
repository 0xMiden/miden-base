...
- Add `TransactionEvent::AbortWithTxEffects` to enable aborting the transaction execution to get its effects for signing purposes ([#1596](https://github.com/0xMiden/miden-base/pull/1596)).
